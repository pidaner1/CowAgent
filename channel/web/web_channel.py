...
class ConfigHandler:
    ...
    EDITABLE_KEYS = {
        ...
        "agent_max_context_tokens", "agent_max_context_turns", "agent_max_steps", "agent_run_timeout",
    ...
    def GET(self):
        ...
        try:
            ...
            return json.dumps({
                ...
                "agent_run_timeout": local_config.get("agent_run_timeout", None),
