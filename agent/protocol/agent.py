...
class Agent:
    def __init__(self, system_prompt: str, description: str = "AI Agent", model: LLMModel = None,
                 ...
                 runtime_info: dict = None, agent_run_timeout: int = None):
        """
        ...
        :param agent_run_timeout: Maximum wall-clock seconds for a single run_stream() call (default: None, no limit)
                    Each user message triggers a new run_stream(); the timeout resets per call.
        """
        ...
        self.agent_run_timeout = agent_run_timeout  # Global wall-clock timeout per run_stream() call
    ...
    def run_stream(self, user_message: str, on_event=None, clear_history: bool = False,
        ...
        executor = AgentStreamExecutor(
            ...
            agent_timeout=self.agent_run_timeout,
        )
